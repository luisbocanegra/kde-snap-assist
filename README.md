...
> [!IMPORTANT]
> Plasma 6 branch is work in progress and still has bugs. If you want to test, check the manual installation instructions below.
...
---
### Manual Installation (plasma6 branch has bugs and is not recommended for regular use)
...
- Download the code as .zip from [plasma6 branch](https://github.com/luisbocanegra/kde-snap-assist/tree/plasma6) (green "Code" button > "Download as ZIP"), and rename file to .kwinscript extension
